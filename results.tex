...
\mychange{According to \citet{Weiss_2003_JAIR}, an oversample rate of $\times$10 is considered to be acceptable in this type of data processing.}
(Arguably, we could have as well undersampled the fair class, but we deemed that unnecessary. Instead, we used a \myremove{strong} \myrevision{heavy} pruning process to prevent overfitting.) Once this process was completed we went on with the decision tree analysis. 
